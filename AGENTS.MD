...
- Use `h-[100dvh]` for full-height application containers.
- Use responsive grids (e.g., `grid-cols-1 md:grid-cols-2`) for layouts.
- Ensure buttons and inputs are touch-friendly (min `py-2.5`).
